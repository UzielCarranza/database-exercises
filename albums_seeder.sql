...
VALUES('Various artists', 'Grease: The Original Soundtrack from the Motion Picture', 1978, 14.4, 'Rock and roll'),
      ('Led Zeppelin', 'Led Zeppelin IV', 1971, 21.1, 'Hard rock, heavy metal, folk rock'),
      ('Michael Jackson', 'Bad', 1987, 24.3, 'Pop, rhythm and blues, funk and rock'),
      ('Alanis MorissettE', 'Jagged Little Pill', 1995, 17.0, 'Alternative rock'),
      ('Michael Jackson	', 'Dangerous', 1991, 21.2, 'New jack swing, R&B and pop'),
